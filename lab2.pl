...
[1.2] Apibrėžkite predikatą „galima nuvažiuoti iš miesto X į miestą Y“:
...
galima_nuvaziuoti(MiestasX, MiestasY, L):- 
    MiestasX \= MiestasY, 
    kelias(MiestasX, MiestasT, KMXT),
    galima_nuvaziuoti(MiestasT, MiestasY, KMTY),
    L is KMTY + KMXT. 

/*
[6] Natūralieji skaičiai yra modeliuojami termais nul, s(nul), s(s(nul)),… 
    (žr. paskaitos medžiagą). Apibrėžkite predikatus:
[6.2] „dviejų skaičių skirtumas lygus trečiajam skaičiui.“
*/
